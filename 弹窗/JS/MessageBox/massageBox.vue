<template>
  <div class="messageBox">
    ...
    <p>{{ conten }}</p>
    <div>
      <div @touchstart="cancelHandler">{{ cancel }}</div>
      <div @touchstart="okHandler">{{ ok }}</div>
    </div>
  </div>
</template>
...
<style scoped>
  .messageBox{width: 200px; height: 140px; border: 1px solid #ccc; border-radius: 4px; background-color: white; box-shadow: 3px 3px 3px 3px #ccc; position: absolute; left: 50%; top: 50%; margin: -70px 0 0 -100px;}
